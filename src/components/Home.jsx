...
const Home = () => {
  return (
    <div name="home" className="h-screen w-full bg-blue">
        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <div>
            <Link
              ...
              smooth
              duration={500}
              className="group text-black w-fit px-6 py-3 my-2 flex items-center rounded-md bg-gradient-to-r from-black to-blue-500 cursor-pointer"
            >
              Portfolio
